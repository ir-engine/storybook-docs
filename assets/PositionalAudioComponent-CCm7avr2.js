import{r as u}from"./index-CeGdYiXw.js";import{a as h,V as w,n as fe,Q as k,f as C,Y as pe,i as W,r as me,s as ve,Z as de,j as ne,b as O,l as j,_ as he,$ as ge,M as ue}from"./three.module-CZEO8pKn.js";import{c as I,N as m,d as Ee,u as ye}from"./ActionFunctions-CSptRlE-.js";import{S as s,c as Y,r as Z,j as J,i as Q,C as ae,u as X,t as T,k as l,n as V,A as D,a as re,g as $,D as R,F as xe}from"./UUIDComponent-CDEdszpG.js";import{i as we}from"./isMobile-BswDFSY8.js";import{c as Me}from"./PriorityQueue-BCBJAnV4.js";import{ad as B,M as g,e as le,aa as Se,d as z,a7 as P,T as G,R as Ae,Z as Ue}from"./GLTFComponent-Z4cCRPGr.js";import{i as Ce}from"./XRState-BUbJG2lz.js";import{b as Oe,T as U}from"./NodeIDComponent-BD5pz7xb.js";import{N as Ie}from"./NodeFunctions-BF8uyDp1.js";import{S as Te,P as oe,r as Ve,g as De,e as Pe}from"./ImageComponent-DJO_faXj.js";import{M as b,a as H,A as be}from"./MediaComponent-Dw4rOKZx.js";new h;new w;new w;new w(0,0,-1);new fe;new w;new h;const Ne=a=>s.LiteralUnion(["cover","contain","vertical","horizontal"],a);new k().setFromAxisAngle(new w(0,1,0),Math.PI/2).multiply(new k().setFromAxisAngle(new w(0,1,0),Math.PI)).multiply(new k().setFromAxisAngle(new w(0,0,1),Math.PI/2));const Ze=Ee({name:"VideoTexturePriorityQueueState",initial:()=>({queue:Me({accumulationBudget:Ce||we?1:3})})});class _e extends de{constructor(e){super(e),this.minFilter=ne,this.magFilter=ne,this.generateMipmaps=!1}update(){}}const ie=s.LiteralUnion([me,W,ve],W),Fe=s.LiteralUnion(["Flat","Equirectangular360"],"Flat"),d=Y({name:"EE_video",jsonID:"EE_video",schema:s.Object({side:Te(O),size:U.Vec2(B),uvOffset:U.Vec2(),uvScale:U.Vec2(B),alphaUVOffset:U.Vec2(),wrapS:ie,wrapT:ie,useAlpha:s.Bool(!1),useAlphaInvert:s.Bool(!1),alphaThreshold:s.Number(.5),fit:Ne("contain"),projection:Fe,mediaUUID:Oe(),videoMeshEntity:s.NonSerialized(s.Entity()),currentVideoSize:s.NonSerialized(U.Vec2(B)),texture:s.NonSerialized(s.Nullable(s.Type()))}),onRemove:(a,e)=>{d.uniqueVideoEntities.includes(a)&&d.uniqueVideoEntities.splice(d.uniqueVideoEntities.indexOf(a),1),Z(a,b)},errors:["INVALID_MEDIA_UUID","MISSING_MEDIA_ELEMENT"],uniqueVideoEntities:[],reactor:je});function je(){const a=J(),e=Q(a,d),p=ae(a,P),c=e.mediaUUID.value,t=Ie.useEntityFromNodeID(a,c)||a,i=X(t,b),o=ae(t,H),E=I(null),f=X(t,d),M=I(()=>{const r=T();return l(r,g,new C(oe(),new pe({uniforms:{map:{value:null},alphaMap:{value:null},uvOffset:{value:new h(0,0)},uvScale:{value:new h(1,1)},useAlpha:{value:!1},alphaThreshold:{value:.5},useAlphaInvert:{value:!1},alphaUVOffset:{value:new h(0,0)},wrapS:{value:W},wrapT:{value:W}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
