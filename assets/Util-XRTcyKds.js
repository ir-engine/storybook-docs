var Te=Object.defineProperty;var Ie=(t,e,i)=>e in t?Te(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i;var P=(t,e,i)=>Ie(t,typeof e!="symbol"?e+"":e,i);import{j as Re,y as _e,F as je,Q as Oe,g as p,h as g,U as f,G as ze,H as X,n as ye,s as m,r as A,d as ve,S as y,u as be,a as q,i as Fe,o as Ae,z as Le,I as Ge,J as $,f as Ue,K as Ne,M as _,k as G,b as Be,x as Ee,v as ee,E,N as V,O as We,R as oe,T as Y}from"./UUIDComponent-DufEZLkx.js";import{u as He,d as Se,b as Qe,a as z,E as Ve,s as Ze,g as U,j as Ce}from"./WebRTCTransportFunctions-D2hRjhXr.js";import{R as C,r as M}from"./index-DPzuYzxM.js";import{O as xe,a as j,G as O,a5 as ie,a6 as Ke,M as Xe,a7 as se,a8 as qe,a9 as Ye,aa as D,e as ae,ab as re,ac as Pe,b as Je,ad as $e,ae as et,a0 as w,af as tt,ag as nt,N as k,T as l,A as ot}from"./GLTFComponent-iOsuRHG8.js";import{U as ce,s as it,a as b,i as st,t as at,u as rt,v as ct,w as lt,W as ut,x as ft,y as Me,z as mt,F as Z,G as le,n as dt,H as pt,k as De,J as ue,f as W,Q as te,E as fe}from"./three.module-CL4TqkoC.js";import{S as N}from"./ShadowComponent-VOqu2KlU.js";import{u as ht,f as gt}from"./FeathersHooks-BR5ogV3p.js";import{E as v}from"./EditorServices-CP3yPfu5.js";import{S}from"./index-CTkfNxwS.js";import{a as yt}from"./utils-HL5mJLhc.js";const me=t=>{for(const[e,i]of Object.entries(t))i&&typeof i.dispose=="function"&&i.dispose();t.dispose()},de=t=>{var o;const e=t;if(e.material&&(Array.isArray(e.material)?e.material.forEach(me):me(e.material)),e.geometry){e.geometry.dispose();for(const s in e.geometry.attributes)e.geometry.deleteAttribute(s)}const i=t;i.isSkinnedMesh&&((o=i.skeleton)==null||o.dispose());const n=t;typeof n.dispose=="function"&&n.dispose()},vt=Re([xe,j]),bt=5*5,Et=()=>{for(const t of vt()){const e=p(t,xe),n=g(t,ie)?ie.squaredDistance[t]>bt:!0,o=!(Ke.isCulled[t]&&n);e.visible=o}},St=t=>{const e=t.entity,i=g(e,f)?f.getAsSourceID(e):"",n=f.useEntitiesBySource(i);return C.createElement(ze,{entities:n,ChildEntityReactor:xt,props:{parentEntity:e}})},Ct=t=>{var n;let e=X(t,se);const i=(n=ye(t,qe))==null?void 0:n.entities.value;if(i){for(const o of i)if(o&&g(o,se)){e=!0;break}}return e},xt=t=>{const e=X(t.entity,Xe),i=X(t.entity,j),n=Ct(t.entity),o=ye(t.parentEntity,N);return M.useEffect(()=>{!e||!i||o&&(n?A(t.entity,N):m(t.entity,N,p(t.parentEntity,N)))},[i,e,n,o==null?void 0:o.cast,o==null?void 0:o.receive]),null},Pt=()=>C.createElement(C.Fragment,null,C.createElement(Oe,{Components:[O],ChildEntityReactor:St}));_e({uuid:"ee.engine.SceneObjectSystem",insert:{after:je},execute:Et,reactor:Pt});const pe=`
#include <common> 
