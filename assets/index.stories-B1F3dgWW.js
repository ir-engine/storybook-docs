import{R as e}from"./index-qyj2ZBCg.js";import{L as u}from"./index-CfKxW7Xz.js";import{t as l}from"./tw-merge-Ds6tgvmq.js";import"./_commonjsHelpers-BosuxZz1.js";const b={sm:"w-9 h-5 after:w-4 after:h-4",md:"w-11 h-6 after:w-5 after:h-5"},h=({size:f,label:o,value:t,onChange:s,disabled:n})=>e.createElement("div",{className:l("flex items-center gap-4",n?"cursor-not-allowed":"cursor-pointer"),"data-testid":"toggle-input-container"},e.createElement("input",{"data-testid":"toggle-input",disabled:n,type:"checkbox",className:"peer sr-only",checked:t,onChange:()=>s(!t)}),e.createElement("div",{className:l("peer relative rounded-full border border-ui-outline after:absolute after:left-[0.0625rem] after:top-1/2 after:-translate-y-1/2  after:rounded-full after:transition-all after:content-['']","peer-checked:border-ui-inactive-primary peer-checked:after:translate-x-full peer-checked:after:border-ui-outline","peer-disabled:ui-inactive-background peer-disabled:pointer-events-none",b[f??"md"],n?"bg-ui-inactive-background after:bg-text-inactive peer-checked:bg-ui-inactive-primary":"bg-ui-background after:bg-text-primary peer-checked:bg-ui-primary"),onClick:()=>s(!t)}),o&&e.createElement(u,{"data-testid":"toggle-input-label"},o)),O={title:"Primitives/Tailwind/Toggle",component:h,parameters:{componentSubtitle:"Toggle",jest:"Toggle.test.tsx",design:{type:"figma",url:""}}},a={args:{label:"Toggle Off Example",value:!1,onChange:()=>{},disabled:!1}},r={args:{label:"Toggle On Example",value:!0,onChange:()=>{},disabled:!1}};var i,c,d;a.parameters={...a.parameters,docs:{...(i=a.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
